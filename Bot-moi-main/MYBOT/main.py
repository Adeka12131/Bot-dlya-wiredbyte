...
async def on_startup(_):
    await bot.send_message(chat_id=OWNER_ID,text='''Привет,я бот-помощник команды WiredByte.
...
async def start_message(message: types.Message):
    photo_path = (r"C:\Users\User\OneDrive\Рабочий стол\Bot-moi-main\WhatsApp Image 2023-12-23 at 19.09.53.jpeg")
    await bot.send_photo(message.chat.id, InputFile(photo_path), caption='Здравствуйте! Я бот команды WiredByte. Чем могу помочь сегодня?', reply_markup=main_keyboard)
